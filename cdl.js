...
let ParserRules = [
    ...
    {"name": "Element", "symbols": ["moveElement"]},
    ...
    {"name": "moveElement$subexpression$1", "symbols": [/[mM]/, /[oO]/, /[vV]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "moveElement", "symbols": ["moveElement$subexpression$1", "WS", {"literal":"("}, "WS", "decimal", "WS", {"literal":")"}, "WS"], "postprocess": data => ({op: "MOVE", n: data[4]})},
