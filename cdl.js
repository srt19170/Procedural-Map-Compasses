...
let ParserRules = [
    ...
    {"name": "rtextElement", "symbols": ["rtextElement$subexpression$1", "WS", {"literal":"("}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "dqList", "WS", {"literal":")"}, "WS"], "postprocess":  data => ({op: "RTEXT", start: data[4], repeats: data[8], font: data[12],
