...
let ParserRules = [
    ...
    {"name": "rcircleElement", "symbols": ["rcircleElement$subexpression$1", "WS", {"literal":"("}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":")"}, "WS"], "postprocess": data => ({op: "RCIRCLE", start: data[4], repeats: data[8], length: data[12], lwidth: data[16], color: data[20], fill: data[24]})},
    {"name": "rtriElement$subexpression$1", "symbols": [/[rR]/, /[tT]/, /[rR]/, /[iI]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "rtriElement", "symbols": ["rtriElement$subexpression$1", "WS", {"literal":"("}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "decimal", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":","}, "WS", "dqstring", "WS", {"literal":")"}, "WS"], "postprocess": data => ({op: "RTRI", start: data[4], repeats: data[8], height: data[12], width: data[16], lwidth: data[20], color: data[24], fill: data[28]})},
