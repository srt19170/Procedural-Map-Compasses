...
let cdlGrammar = {
    '<compass>': '<labels> <ring> <ordinalPoints> <cardinalPoints>',
    '<labels>': 'RTEXT(0, 4, "Serif", 16, "black", "", "bolder", "vertical", ["N", "E", "S", "W"])',
    '<ring>': 'SPACE(23) <thickThin> | SPACE(23) <thinThick> | SPACE(23) <thinThinThin> | SPACE(23) <thinThickThin>',
    ...
    '<thinThickThin>': '<thinCircle> SPACE(3) <thin3Circle> SPACE(3) <thinCircle>',
    '<thin3Circle>': 'CIRCLE(`$thinWidth*3`, "black", "none")',
    '<thickCircle>': 'CIRCLE(<thickWidth>, "black", "none")',
    '<thinCircle>': 'CIRCLE($thinWidth, "black", "none")',
    '<thickWidth>': '4 | 3.5 | 3',
    '$thinWidth': '1.5 | 1 | 0.5',
    '<ordinalPoints>': 'RPOINT(0.7854, 4, 0.85, 1, 1, "black", "white", "black")',
    '<cardinalPoints>': 'SPACE(-22) RPOINT(0, 4, 0.85, 1, 1, "black", "white", "black")'
};

// Top-level function for generation
function generateCDL() {
    const grammar = new RiTa.Grammar(Math.random);
    grammar.load(cdlGrammar);
    return grammar.expandFrom('<compass>', str => eval(str));    
};
...
function executeRules(start, rules, context, otValues=null, parsingJscript=false) {
